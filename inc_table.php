<div class="sidebar-collapse">
    ...
    <ul class="nav metismenu" id="side-menu">
        ...
        <!-- <li>
            <a href="inc_table.php"><i class="fa fa-th-large"></i> <span class="nav-label">Spinners.php</span> <span class="fa arrow"></span></a>
        ...
        <li>
            <a href="/inc_table.php"><i class="fa fa-diamond"></i> <span class="nav-label">Table.php</span></a>
        </li>
        <!-- <li>
